...
public class BannerAdapter extends PagerAdapter {
	...
	private ArrayList<GROModel> listBanner = new ArrayList<GROModel>();
	private LayoutInflater inflater;
	private TouchImageView imgBanner;
	private Activity act;

	public BannerAdapter(final Activity _act, ArrayList<GROModel> _listBanner) {
	...
	public void setData(ArrayList<GROModel> _listBanner) {
		this.listBanner = _listBanner;
	}
	...
	public Object instantiateItem(final View view, final int position) {
		...
		final View imageLayout = this.inflater.inflate(
				R.layout.item_banner_layout, null);
	...
	public void reset(final ArrayList<GROModel> lish) {
