...
import static com.g8.push.CommonUtilities.SENDER_ID;
...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onRegistered(Context context, String registrationId) {
		...
		// Log.v("HAI", "Your device registred with GCM");
		// Log.d("HAI", context+"  "+Main.cont);
		// try {
	...
	protected boolean onRecoverableError(Context context, String errorId) {
		...
		// errorId));
		Log.v("HAI", getString(R.string.gcm_recoverable_error, errorId));
	...
	private static void generateNotification(Context context, String message) {
		...
		UserFunctions.getInstance().getGRO1(context, params, false);
...
//		 notificationManager.notify(0, notification);
	...
	public static void sendMessage(Context cont, String Action,
			Boolean isSuccess) {
